...
import { cartHealth,addCard,finalyCleanCard, myCard,removeSingleItem,viewCarts} from '../../../src/controllers/cartController';
...
productRouter.get('/views', viewCarts as any);
